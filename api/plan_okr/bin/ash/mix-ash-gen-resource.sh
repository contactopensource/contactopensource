...
touch test/my_app/my_domain/plan_okr.exs
...
touch test/my_app_web/live/plan_okrs/form_test.exs
touch test/my_app_web/live/plan_okrs/index_test.exs
touch test/my_app_web/live/plan_okrs/show_test.exs
...
If there is a parent, then edit file lib/my_app/plan_okr.ex to add:
