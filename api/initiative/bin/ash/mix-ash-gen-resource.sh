...
touch test/my_app/my_domain/initiative.exs
...
touch test/my_app_web/live/initiatives/form_test.exs
touch test/my_app_web/live/initiatives/index_test.exs
touch test/my_app_web/live/initiatives/show_test.exs
...
If there is a parent, then edit file lib/my_app/initiative.ex to add:
...
#     index[:sign] \
#     index[:kind] \
#     index[:active_users_actual] \
#     index[:active_users_target] \
#     index[:active_users_ratio] \
#     index[:uptime_percentage_actual] \
#     index[:uptime_percentage_target] \
#     index[:uptime_percentage_ratio] \
#
#
