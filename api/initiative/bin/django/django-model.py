...
- Negative: behind schedule")
        ...
        deployment_frequency_description = models.TextAttribute("deployment frequency description, ideally SMART")
        ...
        lead_time_for_changes_description = models.TextAttribute("Lead time for changes description, ideally SMART")
        ...
        change_failure_rate_description = models.TextAttribute("Change failure rate description, ideally SMART")
        ...
        failed_deployment_recovery_time_description = models.TextAttribute("Failed deployment recovery time description, ideally SMART")
