...
mix ash.gen.resource \
    MyApp.Code.international_standard_industrial_classification_v4s \
    --conflicts replace \
...
touch test/my_app_web/live/international_standard_industrial_classification_v4s/form_live.ex
touch test/my_app_web/live/international_standard_industrial_classification_v4s/index_live.ex
touch test/my_app_web/live/international_standard_industrial_classification_v4s/show_live.ex
...
# Add this:
#
#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#     index[:{attribute.id}]#
#
