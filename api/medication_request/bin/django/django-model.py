...
class MedicationRequest(models.Model):
        ...
        title = models.TextAttribute("The title of the medication request, typically indicating the medication and its purpose.")
        description = models.TextAttribute("A detailed description of the medication request, including the medication name, dosage, and intended use. For example, "A prescription for Aspirin to be taken for pain relief, with a dosage of 100 mg once daily."")
