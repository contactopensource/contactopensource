...
class None(models.Model):
        ...
        subtitle = models.TextAttribute("None")
        global_trade_item_number_id = models.UnknownAttribute("None")
        international_standard_book_number_id = models.UnknownAttribute("None")
