...
class Book(models.Model):
        ...
        global_trade_item_number_id = models.ForeignKey("None", GlobalTradeItemNumberId, on_delete=models.CASCADE)("None")
        international_standard_book_number_id = models.ForeignKey("None", InternationalStandardBookNumberId, on_delete=models.CASCADE)("None")
