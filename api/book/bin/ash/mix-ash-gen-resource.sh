...
touch test/my_app/my_domain/book.exs
...
touch test/my_app_web/live/books/form_test.exs
touch test/my_app_web/live/books/index_test.exs
touch test/my_app_web/live/books/show_test.exs
...
If there is a parent, then edit file lib/my_app/book.ex to add:
