...
defmodule MyApp.MyDomain.Book.Attributes do
  ...
  attributes do
    ...
    attribute :subtitle, :text do
    end

    attribute :global_trade_item_number_id, :global_trade_item_number.id do
    end

    attribute :international_standard_book_number_id, :international_standard_book_number.id do
    end
