...
mix phx.gen.html \
    None PlanSMART None \
        ...
        specific_card_id:referencesNone \
        measurable_card_id:referencesNone \
        achievable_card_id:referencesNone \
        relevant_card_id:referencesNone \
        timely_card_id:referencesNone \
    --force \
    --no-timestamps \
