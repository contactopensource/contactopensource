...
class PlanSMART(models.Model):
        ...
        relevant_card_id = models.UnknownAttribute("Relevant: closely connected to what's happening and being considered.")
        timely_card_id = models.UnknownAttribute("Timely: occurring at a favorable or useful time and opportune.")
