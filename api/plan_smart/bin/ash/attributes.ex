...
defmodule MyApp.MyDomain.PlanSMART.Attributes do
  ...
  attributes do
    ...
    attribute :specific_card_id, :card.id do
      description "Specific: target one area clearly and precisely."
    end

    attribute :measurable_card_id, :card.id do
      description "Measurable: quantify progress toward success by using metrics."
    end

    attribute :achievable_card_id, :card.id do
      description "Achievable: able to start, able to continue, and able to accomplish."
    end

    attribute :relevant_card_id, :card.id do
      description "Relevant: closely connected to what's happening and being considered."
    end

    attribute :timely_card_id, :card.id do
      description "Timely: occurring at a favorable or useful time and opportune."
    end
