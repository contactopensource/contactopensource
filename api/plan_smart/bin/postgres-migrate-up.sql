...
CREATE INDEX index_plan_smart_retired_at on plan_smart(retired_at);
CREATE INDEX index_plan_smart_retired_by on plan_smart(retired_by);
CREATE INDEX index_plan_smart_locale_code on plan_smart(locale_code);
CREATE INDEX index_plan_smart_tagging on plan_smart(tagging);
CREATE INDEX index_plan_smart_name on plan_smart(name);
CREATE INDEX index_plan_smart_subname on plan_smart(subname);
