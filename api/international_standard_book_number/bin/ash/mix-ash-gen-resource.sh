...
mix ash.gen.resource \
    MyApp.Code.InternationalStandardBookNumber \
    --conflicts replace \
...
touch test/my_app/my_domain/international_standard_book_number.exs
...
touch test/my_app_web/live/international_standard_book_numbers/form_test.exs
touch test/my_app_web/live/international_standard_book_numbers/index_test.exs
touch test/my_app_web/live/international_standard_book_numbers/show_test.exs
...
If there is a parent, then edit file lib/my_app/international_standard_book_number.ex to add:
