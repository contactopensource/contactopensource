...
defmodule MyApp.MyDomain.InternationalStandardBookNumber.Attributes do
  ...
  attributes do
    ...
    attribute :prefix_element, :string do
    end

    attribute :registration_group, :digit do
    end

    attribute :registrant, :string do
    end

    attribute :publication, :string do
    end
