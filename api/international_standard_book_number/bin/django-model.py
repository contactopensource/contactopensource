...
class InternationalStandardBookNumber(models.Model):
        ...
        prefix_element = models.UnknownAttribute("None")
        registration_group = models.UnknownAttribute("None")
        registrant = models.UnknownAttribute("None")
        publication = models.UnknownAttribute("None")
        check_digit = models.UnknownAttribute("None")
