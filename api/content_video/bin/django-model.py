...
class ContentVideo(models.Model):
        ...
        codec_id = models.UnknownAttribute("codec id")
        width_as_pixels = models.UnknownAttribute("width as pixels")
        height_as_pixels = models.UnknownAttribute("height as pixels")
        duration_as_seconds = models.UnknownAttribute("duration as seconds")
