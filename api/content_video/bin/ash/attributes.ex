...
defmodule MyApp.MyDomain.ContentVideo.Attributes do
  ...
  attributes do
    ...
    attribute :codec_id, :codec.id do
      description "codec id"
    end

    attribute :width_as_pixels, :count do
      description "width as pixels"
    end

    attribute :height_as_pixels, :count do
      description "height as pixels"
    end

    attribute :duration_as_seconds, :count do
      description "duration as seconds"
    end
