...
CREATE INDEX index_content_video_retired_at on content_video(retired_at);
CREATE INDEX index_content_video_retired_by on content_video(retired_by);
CREATE INDEX index_content_video_locale_code on content_video(locale_code);
CREATE INDEX index_content_video_tagging on content_video(tagging);
