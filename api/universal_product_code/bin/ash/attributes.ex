...
defmodule MyApp.MyDomain.UniversalProductCode.Attributes do
  ...
  attributes do
    ...
    attribute :image_url, :text do
      description "An image for the item, as a URL."
    end

    attribute :image_alt, :text do
      description "An image for the item, as an alternate text description."
    end
