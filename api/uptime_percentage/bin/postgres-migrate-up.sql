...
CREATE INDEX index_uptime_percentage_deleted_at on uptime_percentage(deleted_at);
CREATE INDEX index_uptime_percentage_deleted_by on uptime_percentage(deleted_by);
