...
class UptimePercentage(models.Model):
        ...
        actual = models.UnknownAttribute("Uptime percentage actual value")
        target = models.UnknownAttribute("Uptime percentage target value")
        ratio = models.UnknownAttribute("Uptime percentage ratio = (actual / target)")
        unit = models.TextAttribute("Uptime percentage unit")
        description = models.TextAttribute("Uptime percentage description")
