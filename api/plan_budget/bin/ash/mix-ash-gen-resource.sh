...
touch test/my_app/my_domain/plan_budget.exs
...
touch test/my_app_web/live/plan_budgets/form_test.exs
touch test/my_app_web/live/plan_budgets/index_test.exs
touch test/my_app_web/live/plan_budgets/show_test.exs
...
If there is a parent, then edit file lib/my_app/plan_budget.ex to add:
