...
defmodule MyApp.MyDomain.EmailContact.Attributes do
  ...
  attributes do
    ...
    attribute :address, :text do
      description "See https://tools.ietf.org/html/rfc5322"
    end

    attribute :display_name, :text do
      description "display name"
    end

    attribute :addr_spec, :text do
      description "addr spec"
    end

    attribute :local_part, :text do
