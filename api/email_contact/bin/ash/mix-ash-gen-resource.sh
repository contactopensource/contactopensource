...
touch test/my_app/my_domain/email_contact.exs
...
touch test/my_app_web/live/email_contacts/form_test.exs
touch test/my_app_web/live/email_contacts/index_test.exs
touch test/my_app_web/live/email_contacts/show_test.exs
...
If there is a parent, then edit file lib/my_app/email_contact.ex to add:
