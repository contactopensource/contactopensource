...
class EmailContact(models.Model):
        ...
        address = models.TextAttribute("See https://tools.ietf.org/html/rfc5322")
        display_name = models.TextAttribute("display name")
        addr_spec = models.TextAttribute("addr spec")
        local_part = models.TextAttribute("local part")
