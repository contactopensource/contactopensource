...
defmodule MyApp.MyDomain.Color Point CYMKA With Byte.Attributes do
  ...
  attributes do
    ...
    attribute :cyan, :byte do
      description "cyan"
    end

    attribute :yellow, :byte do
      description "yellow"
    end

    attribute :magenta, :byte do
      description "magenta"
    end

    attribute :black, :byte do
      description "black"
    end

    attribute :alpha, :byte do
      description "alpha"
    end
