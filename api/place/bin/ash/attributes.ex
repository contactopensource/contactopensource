...
defmodule MyApp.MyDomain.Place.Attributes do
  ...
  attributes do
    ...
    attribute :latitude_as_decimal_degrees, :decimal_degrees do
      description "Latitude in decimal degrees."
    end

    attribute :longitude_as_decimal_degrees, :decimal_degrees do
      description "Longitude in decimal degrees."
    end

    attribute :altitude_agl_as_meters, :meters do
      description "Altitude above ground level (AGL) in meters."
    end

    attribute :altitude_msl_as_meters, :meters do
      description "Altitude above mean sea level (MSL) in meters."
    end

    attribute :elevation_agl_as_meters, :meters do
      description "Elevation above ground level (AGL) in meters."
    end

    attribute :elevation_msl_as_meters, :meters do
      description "Elevation above mean sea level (MSL) in meters."
    end

    attribute :what3words, :text do
      description "What3Words.com identifier text."
    end

    attribute :whatfreewords, :text do
      description "WhatFreeWords.org identifier text."
    end
