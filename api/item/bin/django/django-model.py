...
class Item(models.Model):
        ...
        geographic_point_id = models.ForeignKey("Generic geographic point, such as the item's current location.", GeographicPointId, on_delete=models.CASCADE)("Generic geographic point, such as the item's current location.")
        color_point_rgb_with_unit_interval_id = models.ForeignKey("Generic color point, such as the item's current color", ColorPointRgbWithUnitIntervalId, on_delete=models.CASCADE)("Generic color point, such as the item's current color")
        quick_response_code_id = models.ForeignKey("None", QuickResponseCodeId, on_delete=models.CASCADE)("None")
        stock_keeping_unit_id = models.ForeignKey("None", StockKeepingUnitId, on_delete=models.CASCADE)("None")
        universal_product_code_id = models.ForeignKey("None", UniversalProductCodeId, on_delete=models.CASCADE)("None")
