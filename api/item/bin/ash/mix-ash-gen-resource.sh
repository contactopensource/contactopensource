...
touch test/my_app/my_domain/item.exs
...
touch test/my_app_web/live/items/form_test.exs
touch test/my_app_web/live/items/index_test.exs
touch test/my_app_web/live/items/show_test.exs
...
If there is a parent, then edit file lib/my_app/item.ex to add:
