...
defmodule MyApp.MyDomain.Item.Attributes do
  ...
  attributes do
    ...
    attribute :geographic_point_id, :geographic_point.id do
      description "Generic geographic point, such as the item's current location."
    end

    attribute :color_point_rgb_with_unit_interval_id, :color_point_rgb_with_unit_interval.id do
      description "Generic color point, such as the item's current color"
    end

    attribute :quick_response_code_id, :quick_response_code.id do
    end

    attribute :stock_keeping_unit_id, :stock_keeping_unit.id do
    end
