...
touch test/my_app/my_domain/ethnicity.exs
...
touch test/my_app_web/live/ethnicitys/form_test.exs
touch test/my_app_web/live/ethnicitys/index_test.exs
touch test/my_app_web/live/ethnicitys/show_test.exs
...
If there is a parent, then edit file lib/my_app/ethnicity.ex to add:
