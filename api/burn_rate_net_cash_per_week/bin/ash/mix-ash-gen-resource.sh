...
touch test/my_app/my_domain/burn_rate_net_cash_per_week.exs
...
touch test/my_app_web/live/burn_rate_net_cash_per_weeks/form_test.exs
touch test/my_app_web/live/burn_rate_net_cash_per_weeks/index_test.exs
touch test/my_app_web/live/burn_rate_net_cash_per_weeks/show_test.exs
...
If there is a parent, then edit file lib/my_app/burn_rate_net_cash_per_week.ex to add:
