...
touch test/my_app/my_domain/geography_point.exs
...
touch test/my_app_web/live/geography_points/form_test.exs
touch test/my_app_web/live/geography_points/index_test.exs
touch test/my_app_web/live/geography_points/show_test.exs
...
If there is a parent, then edit file lib/my_app/geography_point.ex to add:
