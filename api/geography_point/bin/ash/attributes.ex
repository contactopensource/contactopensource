...
defmodule MyApp.MyDomain.GeographyPoint.Attributes do
  ...
  attributes do
    ...
    attribute :latitude_as_decimal_degrees, :decimal_degrees do
      description "latitude as decimal degrees"
    end

    attribute :longitude_as_decimal_degrees, :decimal_degrees do
      description "longitude as decimal degrees"
    end

    attribute :altitude_agl_as_meters, :meters do
      description "altitude above ground level (AGL)"
    end

    attribute :altitude_msl_as_meters, :meters do
      description "altitude relative to mean sea level (MSL)"
    end

    attribute :elevation_agl_as_meters, :meters do
      description "elevation above ground level (AGL)"
    end

    attribute :elevation_msl_as_meters, :meters do
      description "elevation relative to mean sea level (MGL)"
    end
