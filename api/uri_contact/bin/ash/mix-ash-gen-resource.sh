...
touch test/my_app/my_domain/uri_contact.exs
...
touch test/my_app_web/live/uri_contacts/form_test.exs
touch test/my_app_web/live/uri_contacts/index_test.exs
touch test/my_app_web/live/uri_contacts/show_test.exs
...
If there is a parent, then edit file lib/my_app/uri_contact.ex to add:
