...
CREATE INDEX index_content_text_retired_at on content_text(retired_at);
CREATE INDEX index_content_text_retired_by on content_text(retired_by);
CREATE INDEX index_content_text_locale_code on content_text(locale_code);
CREATE INDEX index_content_text_tagging on content_text(tagging);
