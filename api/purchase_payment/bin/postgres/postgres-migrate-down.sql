...
DROP INDEX IF EXISTS index_purchase_payment_updated_by;
DROP INDEX IF EXISTS index_purchase_payment_retired_at;
DROP INDEX IF EXISTS index_purchase_payment_retired_by;
