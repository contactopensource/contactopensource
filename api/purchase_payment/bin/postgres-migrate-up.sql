...
CREATE INDEX index_purchase_payment_retired_at on purchase_payment(retired_at);
CREATE INDEX index_purchase_payment_retired_by on purchase_payment(retired_by);
