...
mix ash.gen.resource \
    MyApp.None.burn_rate_net_time_per_weeks \
    --conflicts replace \
...
touch test/my_app_web/live/burn_rate_net_time_per_weeks/form_live.ex
touch test/my_app_web/live/burn_rate_net_time_per_weeks/index_live.ex
touch test/my_app_web/live/burn_rate_net_time_per_weeks/show_live.ex
