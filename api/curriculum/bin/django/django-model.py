...
class Curriculum(models.Model):
        ...
        purpose_description_as_markdown = models.UnknownAttribute("The purpose of this curriculum. For example, aims, goals, intents, knowledge, needs, objectives, outcomes, and skills, that students should gain at different stages.")
        process_description_as_markdown = models.UnknownAttribute("The process of this curriculum. For example, implementations, structures, narratives, activities, resources, intracurriculars (i.e. formal experiences), extracurriculars (i.e. informal experiences), and unspoken lessons (hidden curriculum like social norms).")
        evaluation_description_as_markdown = models.UnknownAttribute("The evaluation of this curriculum. For example, tests, exams, certifications, peer review, project-based outputs, formative assessments, summative assessments, etc.")
        continuation_description_as_markdown = models.UnknownAttribute("The continuation of this curriculum. For example, continuous improvement, feedback from stakeholders, maintenance, lifecycles.")
