...
defmodule MyApp.MyDomain.MeasurementUnit.Attributes do
  ...
  attributes do
    ...
    attribute :id, :string do
      primary_key? true
      description "Id is a case-sensitive code as defined by the UCUM data file"
    end
