...
touch test/my_app/my_domain/meta.exs
...
touch test/my_app_web/live/metas/form_test.exs
touch test/my_app_web/live/metas/index_test.exs
touch test/my_app_web/live/metas/show_test.exs
...
If there is a parent, then edit file lib/my_app/meta.ex to add:
