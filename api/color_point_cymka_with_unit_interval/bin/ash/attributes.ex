...
defmodule MyApp.MyDomain.ColorPointCYMKAWithUnitInterval.Attributes do
  ...
  attributes do
    ...
    attribute :cyan, :unit_interval do
      description "cyan"
    end

    attribute :yellow, :unit_interval do
      description "yellow"
    end

    attribute :magenta, :unit_interval do
      description "magenta"
    end

    attribute :black, :unit_interval do
      description "black"
    end

    attribute :alpha, :unit_interval do
      description "alpha"
    end
