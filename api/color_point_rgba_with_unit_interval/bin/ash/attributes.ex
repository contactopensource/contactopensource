...
defmodule MyApp.MyDomain.ColorPointRGBAWithUnitInterval.Attributes do
  ...
  attributes do
    ...
    attribute :red, :unit_interval do
      description "red"
    end

    attribute :green, :unit_interval do
      description "green"
    end

    attribute :blue, :unit_interval do
      description "blue"
    end
