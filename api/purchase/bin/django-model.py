...
class Purchase(models.Model):
        ...
        image_1024x1024_url = models.URLAttribute("An image for the item, 1024x1024 pixels, which is square 1:1 aspect ratio, as a URL.")
        image_1024x1024_alt = models.TextAttribute("An image for the item, 1024x1024 pixels, which is square 1:1 aspect ratio, as an alternate text description.")
