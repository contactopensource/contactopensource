...
mix phx.gen.html \
    None DoraMetricsKit None \
        ...
        reliability_unit_interval_actual:numeric(9,6)None \
        reliability_unit_interval_target:numeric(9,6)None \
        reliability_unit_interval_ratio:numeric(9,6)None \
        reliability_unit_interval_unit:textNone \
        reliability_unit_interval_description:textNone \
    --force \
    --no-timestamps \
