...
class DoraMetricsKit(models.Model):
        ...
        reliability_unit_interval_actual = models.UnknownAttribute("Reliability unit interval actual value")
        reliability_unit_interval_target = models.UnknownAttribute("Reliability unit interval target value")
        reliability_unit_interval_ratio = models.UnknownAttribute("Reliability unit interval (actual / target)")
        reliability_unit_interval_unit = models.TextAttribute("Reliability unit interval unit")
        reliability_unit_interval_description = models.TextAttribute("Reliability unit interval description")
