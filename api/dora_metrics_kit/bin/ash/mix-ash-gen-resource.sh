...
mix ash.gen.resource \
    ...
    --attribute reliability_unit_interval_actual:numeric \
    --attribute reliability_unit_interval_target:numeric \
    --attribute reliability_unit_interval_ratio:numeric \
    --attribute reliability_unit_interval_unit:text \
    --attribute reliability_unit_interval_description:text \
