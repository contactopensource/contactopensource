...
class PhoneContact(models.Model):
        ...
        e164_text = models.TextAttribute("e164 text")
        e164_country_code = models.TextAttribute("e164 country code")
        e164_national_destination_code = models.TextAttribute("e164 national destination code")
        e164_group_identification_code = models.TextAttribute("e164 group identification code")
        e164_trial_identification_code = models.TextAttribute("e164 trial identification code")
        e164_subscriber_number = models.TextAttribute("e164 subscriber number")
