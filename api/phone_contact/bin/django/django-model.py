...
class PhoneContact(models.Model):
        ...
        label = models.TextAttribute("label")
        number_text = models.TextAttribute("number text")
        e164_text = models.UnknownAttribute("e164 text")
        e164_country_code = models.UnknownAttribute("e164 country code")
        e164_national_destination_code = models.UnknownAttribute("e164 national destination code")
        e164_group_identification_code = models.UnknownAttribute("e164 group identification code")
        e164_trial_identification_code = models.UnknownAttribute("e164 trial identification code")
        e164_subscriber_number = models.UnknownAttribute("e164 subscriber number")
