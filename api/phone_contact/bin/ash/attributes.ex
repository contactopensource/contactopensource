...
defmodule MyApp.MyDomain.PhoneContact.Attributes do
  ...
  attributes do
    ...
    attribute :label, :text do
      description "label"
    end

    attribute :number_text, :text do
      description "number text"
    end

    attribute :e164_text, :string do
      description "e164 text"
    end

    attribute :e164_country_code, :string do
      description "e164 country code"
    end

    attribute :e164_national_destination_code, :string do
      description "e164 national destination code"
    end

    attribute :e164_group_identification_code, :string do
      description "e164 group identification code"
    end

    attribute :e164_trial_identification_code, :string do
      description "e164 trial identification code"
    end

    attribute :e164_subscriber_number, :string do
      description "e164 subscriber number"
    end
