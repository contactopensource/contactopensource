...
defmodule MyApp.MyDomain.PlanROPE.Attributes do
  ...
  attributes do
    ...
    attribute :measurement_unit_id, :measurement_unit.id do
      description "measurement unit"
    end

    attribute :realistic, :card.id do
      description "Realistic estimate. This is based on work being typical, reasonable, plausible, and usual."
    end

    attribute :optimistic, :card.id do
      description "Optimistic estimate. This is based on work turning out to be notably easy, or fast, or lucky."
    end

    attribute :pessimistic, :card.id do
      description "Pessimistic estimate. This is based on work turning out to be notably hard, or slow, or unlucky."
    end

    attribute :equilibristic, :card.id do
      description "Equilibristic estimate. This is based on success as 50% likely such as for critical chains and simulations."
    end
