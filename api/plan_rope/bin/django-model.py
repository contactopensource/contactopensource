...
class PlanROPE(models.Model):
        ...
        measurement_unit_id = models.ForeignKey("measurement unit", MeasurementUnitId, on_delete=models.CASCADE)("measurement unit")
        realistic = models.ForeignKey("Realistic estimate. This is based on work being typical, reasonable, plausible, and usual.", Realistic, on_delete=models.CASCADE)("Realistic estimate. This is based on work being typical, reasonable, plausible, and usual.")
        optimistic = models.ForeignKey("Optimistic estimate. This is based on work turning out to be notably easy, or fast, or lucky.", Optimistic, on_delete=models.CASCADE)("Optimistic estimate. This is based on work turning out to be notably easy, or fast, or lucky.")
        pessimistic = models.ForeignKey("Pessimistic estimate. This is based on work turning out to be notably hard, or slow, or unlucky.", Pessimistic, on_delete=models.CASCADE)("Pessimistic estimate. This is based on work turning out to be notably hard, or slow, or unlucky.")
        equilibristic = models.ForeignKey("Equilibristic estimate. This is based on success as 50% likely such as for critical chains and simulations.", Equilibristic, on_delete=models.CASCADE)("Equilibristic estimate. This is based on success as 50% likely such as for critical chains and simulations.")
