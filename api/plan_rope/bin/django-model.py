...
class PlanROPE(models.Model):
        ...
        measurement_unit_id = models.UnknownAttribute("measurement unit")
        realistic = models.UnknownAttribute("Realistic estimate. This is based on work being typical, reasonable, plausible, and usual.")
        optimistic = models.UnknownAttribute("Optimistic estimate. This is based on work turning out to be notably easy, or fast, or lucky.")
        pessimistic = models.UnknownAttribute("Pessimistic estimate. This is based on work turning out to be notably hard, or slow, or unlucky.")
        equilibristic = models.UnknownAttribute("Equilibristic estimate. This is based on success as 50% likely such as for critical chains and simulations.")
