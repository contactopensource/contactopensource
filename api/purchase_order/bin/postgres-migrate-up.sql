...
CREATE INDEX index_purchase_order_retired_at on purchase_order(retired_at);
CREATE INDEX index_purchase_order_retired_by on purchase_order(retired_by);
CREATE INDEX index_purchase_order_locale_code on purchase_order(locale_code);
CREATE INDEX index_purchase_order_tagging on purchase_order(tagging);
