...
touch test/my_app/my_domain/purchase_order.exs
...
touch test/my_app_web/live/purchase_orders/form_test.exs
touch test/my_app_web/live/purchase_orders/index_test.exs
touch test/my_app_web/live/purchase_orders/show_test.exs
...
If there is a parent, then edit file lib/my_app/purchase_order.ex to add:
