...
class PlanGIST(models.Model):
        ...
        goal_card_id = models.ForeignKey("Goal", GoalCardId, on_delete=models.CASCADE)("Goal")
        idea_card_id = models.ForeignKey("Idea", IdeaCardId, on_delete=models.CASCADE)("Idea")
        step_card_id = models.ForeignKey("Step", StepCardId, on_delete=models.CASCADE)("Step")
        task_card_id = models.ForeignKey("Task", TaskCardId, on_delete=models.CASCADE)("Task")
