...
class PlanGIST(models.Model):
        ...
        goal_card_id = models.UnknownAttribute("Goal")
        idea_card_id = models.UnknownAttribute("Idea")
        step_card_id = models.UnknownAttribute("Step")
        task_card_id = models.UnknownAttribute("Task")
