...
defmodule MyApp.MyDomain.PlanGIST.Attributes do
  ...
  attributes do
    ...
    attribute :goal_card_id, :card.id do
      description "Goal"
    end

    attribute :idea_card_id, :card.id do
      description "Idea"
    end

    attribute :step_card_id, :card.id do
      description "Step"
    end

    attribute :task_card_id, :card.id do
      description "Task"
    end
