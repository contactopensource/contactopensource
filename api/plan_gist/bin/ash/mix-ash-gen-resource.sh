...
mix ash.gen.resource \
    ...
    --relationship belongs_to:goal_card_id:MyApp.MyDomain.MyModel \
    --relationship belongs_to:idea_card_id:MyApp.MyDomain.MyModel \
    --relationship belongs_to:step_card_id:MyApp.MyDomain.MyModel \
    --relationship belongs_to:task_card_id:MyApp.MyDomain.MyModel \

mix ash.codegen create_plan_gists
mix ash.migrate

touch priv/repo/migrations/00000000000000_create_plan_gists.exs
touch test/my_app/my_domain/plan_gist.exs
...
touch test/my_app_web/live/plan_gists/form_test.exs
touch test/my_app_web/live/plan_gists/index_test.exs
touch test/my_app_web/live/plan_gists/show_test.exs
...
If there is a parent, then edit file lib/my_app/plan_gist.ex to add:
