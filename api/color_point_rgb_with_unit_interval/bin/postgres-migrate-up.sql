...
CREATE INDEX index_color_point_rgb_with_unit_interval_updated_by on color_point_rgb_with_unit_interval(updated_by);
CREATE INDEX index_color_point_rgb_with_unit_interval_retired_at on color_point_rgb_with_unit_interval(retired_at);
CREATE INDEX index_color_point_rgb_with_unit_interval_retired_by on color_point_rgb_with_unit_interval(retired_by);
