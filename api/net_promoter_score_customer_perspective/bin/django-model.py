...
class NetPromoterScoreKitCustomerPerspective(models.Model):
        ...
        actual = models.UnknownAttribute("Actual value")
        expect = models.UnknownAttribute("Target value")
        ratio = models.UnknownAttribute("Ratio = (actual / expect)")
        unit = models.TextAttribute("unit")
        description_as_markdown = models.TextAttribute("Net Promoter Score (NPS)  customer perspective, description as markdown")
