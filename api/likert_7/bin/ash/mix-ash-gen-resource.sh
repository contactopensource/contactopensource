...
touch test/my_app/my_domain/likert_7.exs
...
touch test/my_app_web/live/likert_7s/form_test.exs
touch test/my_app_web/live/likert_7s/index_test.exs
touch test/my_app_web/live/likert_7s/show_test.exs
...
If there is a parent, then edit file lib/my_app/likert_7.ex to add:
