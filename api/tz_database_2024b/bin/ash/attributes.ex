...
defmodule MyApp.MyDomain.TzDatabase2024b.Attributes do
  ...
  attributes do
    ...
    attribute :country_code, :string do
      description "Country code: ISO 3166 2-character country code.  See the file `iso3166.tab'."
    end

    attribute :country_id, :country.id do
    end

    attribute :latitude_as_decimal_minute_second, :iso_6709 do
    end

    attribute :latitude_as_decimal_degrees, :decimal_degrees do
    end

    attribute :longitude_as_decimal_minute_second, :text do
    end
