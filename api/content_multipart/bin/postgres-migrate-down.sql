...
DROP INDEX IF EXISTS index_content_multipart_updated_by;
DROP INDEX IF EXISTS index_content_multipart_deleted_at;
DROP INDEX IF EXISTS index_content_multipart_deleted_by;
DROP INDEX IF EXISTS index_content_multipart_locale_id;
