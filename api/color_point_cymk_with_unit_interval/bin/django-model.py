...
class ColorPointCYMKWithUnitInterval(models.Model):
        ...
        cyan = models.UnknownAttribute("None")
        yellow = models.UnknownAttribute("None")
        magenta = models.UnknownAttribute("None")
        black = models.UnknownAttribute("None")
