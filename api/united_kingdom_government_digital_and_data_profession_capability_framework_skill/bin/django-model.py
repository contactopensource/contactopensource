...
class UnitedKingdomGovernmentDigitalAndDataProfessionCapabilityFrameworkSkill(models.Model):
        ...
        level_1_as_markdown = models.UnknownAttribute("Skill level 1 is "Awareness"; this field is the exact markdown from the official download CSV.")
        level_1_as_html = models.UnknownAttribute("Skill level 1 is "Awareness"; this field is the cache conversion into HTML list items.")
        level_2_as_markdown = models.UnknownAttribute("Skill level 2 is "Working"; this field is the exact markdown from the official download CSV.")
        level_2_as_html = models.UnknownAttribute("Skill level 2 is "Working"; this field is the cache conversion into HTML list items.")
        level_3_as_markdown = models.UnknownAttribute("Skill level 3 is "Practitioner; this field is the exact markdown from the official download CSV.")
        level_3_as_html = models.UnknownAttribute("Skill level 3 is "Practitioner"; this field is the cache conversion into HTML list items.")
        level_4_as_markdown = models.UnknownAttribute("Skill level 4 is "Expert"; this field is the exact markdown from the official download CSV.")
        level_4_as_html = models.UnknownAttribute("Skill level 4 is "Expert"; this field is the cache conversion into HTML list items.")
