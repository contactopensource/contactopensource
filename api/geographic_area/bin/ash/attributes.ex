...
defmodule MyApp.MyDomain.GeographicArea.Attributes do
  ...
  attributes do
    ...
    attribute :population_count, :count do
    end

    attribute :area_as_meter2, :meter2 do
    end

    attribute :center_geographic_point, :geographic_point do
    end
