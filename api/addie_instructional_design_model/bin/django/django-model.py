...
class ADDIEInstructionalDesignModel(models.Model):
        ...
        phase_1_analysis_as_markdown = models.UnknownAttribute("Identify training needs, conducting job task analysis (JDTA), and determining performance gaps.")
        phase_2_design_as_markdown = models.UnknownAttribute("Develop learning objectives, assessment tools, and the training structure.")
        phase_3_development_as_markdown = models.UnknownAttribute("Create the actual training materials, including courseware and instructor guides.")
        phase_4_implementation_as_markdown = models.UnknownAttribute("Deliver the training to sailors, often via Navy eLearning (NeL) or in-person instruction.")
        phase_5_evaluation_as_markdown = models.UnknownAttribute("Assess the effectiveness of the training (internal and external) to ensure it meets operational requirements.")
