...
DROP INDEX IF EXISTS index_plan_milestone_updated_by;
DROP INDEX IF EXISTS index_plan_milestone_retired_at;
DROP INDEX IF EXISTS index_plan_milestone_retired_by;
DROP INDEX IF EXISTS index_plan_milestone_locale_code;
DROP INDEX IF EXISTS index_plan_milestone_tagging;
DROP INDEX IF EXISTS index_plan_milestone_name;
DROP INDEX IF EXISTS index_plan_milestone_subname;
DROP INDEX IF EXISTS index_plan_milestone_slug;
