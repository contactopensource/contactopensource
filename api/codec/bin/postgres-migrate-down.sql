...
DROP INDEX IF EXISTS index_codec_updated_by;
DROP INDEX IF EXISTS index_codec_deleted_at;
DROP INDEX IF EXISTS index_codec_deleted_by;
DROP INDEX IF EXISTS index_codec_locale_id;
