...
touch test/my_app/my_domain/codec.exs
...
touch test/my_app_web/live/codecs/form_test.exs
touch test/my_app_web/live/codecs/index_test.exs
touch test/my_app_web/live/codecs/show_test.exs
...
If there is a parent, then edit file lib/my_app/codec.ex to add:
