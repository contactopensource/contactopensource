...
defmodule MyApp.MyDomain.Codec.Attributes do
  ...
  attributes do
    ...
    attribute :code, :text do
      description "code"
    end

    attribute :icon, :text do
      description "icon"
    end

    attribute :link, :text do
      description "link"
    end

    attribute :note, :text do
      description "note"
    end

    attribute :creator_name, :text do
      description "creator name"
    end

    attribute :prefer_file_extension, :text do
      description "prefer file extension"
    end

    attribute :prefer_media_type_id, :media_type.id do
      description "prefer media type id"
    end

    attribute :lossy_flag, :boolean do
      description "true = lossy encoding; false = lossless encoding"
    end

    attribute :floss_flag, :boolean do
      description "floss flag"
    end

    attribute :fixed_bit_rate, :numeric do
      description "fixed bit rate"
    end

    attribute :variable_bit_rate_minimum, :numeric do
      description "variable bit rate minimum"
    end

    attribute :variable_bit_rate_maximum, :numeric do
      description "variable bit rate maximum"
    end

    attribute :fixed_channel_count, :integer do
      description "fixed channel count"
    end

    attribute :variable_channel_count_minimum, :integer do
      description "variable channel count minimum"
    end

    attribute :variable_channel_count_maximum, :integer do
      description "variable channel count maximum"
    end
