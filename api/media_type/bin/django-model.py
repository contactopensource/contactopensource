...
class MediaType(models.Model):
        ...
        text = models.TextAttribute("string")
        supertype = models.TextAttribute("supertype")
        subtype = models.TextAttribute("subtype")
        tree = models.TextAttribute("tree")
        suffix = models.TextAttribute("suffix")
        parameters = models.UnknownAttribute("parameters")
