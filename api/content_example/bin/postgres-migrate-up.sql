...
CREATE INDEX index_content_example_deleted_at on content_example(deleted_at);
CREATE INDEX index_content_example_deleted_by on content_example(deleted_by);
CREATE INDEX index_content_example_locale_id on content_example(locale_id);
CREATE INDEX index_content_example_title on content_example(title);
CREATE INDEX index_content_example_subtitle on content_example(subtitle);
