...
CREATE INDEX question_subname_index on question(subname);
CREATE INDEX question_slug_index on question(slug);
CREATE INDEX question_sign_index on question(sign);
CREATE INDEX question_kind_index on question(kind);
