...
touch test/my_app/my_domain/node.exs
...
touch test/my_app_web/live/nodes/form_test.exs
touch test/my_app_web/live/nodes/index_test.exs
touch test/my_app_web/live/nodes/show_test.exs
...
If there is a parent, then edit file lib/my_app/node.ex to add:
