...
CREATE INDEX index_timestamp_range_retired_at on timestamp_range(retired_at);
CREATE INDEX index_timestamp_range_retired_by on timestamp_range(retired_by);
