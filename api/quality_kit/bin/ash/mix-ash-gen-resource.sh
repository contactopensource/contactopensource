...
touch test/my_app/my_domain/quality_kit.exs
...
touch test/my_app_web/live/quality_kits/form_test.exs
touch test/my_app_web/live/quality_kits/index_test.exs
touch test/my_app_web/live/quality_kits/show_test.exs
...
If there is a parent, then edit file lib/my_app/quality_kit.ex to add:
