...
defmodule MyApp.MyDomain.Measurement.Attributes do
  ...
  attributes do
    ...
    attribute :timestamp_utc_usec, :timestamp_utc_usec do
    ...
    attribute :measurement_device_id, :measurement_device.id do
      description "Measurement device id"
    end

    attribute :value, :TODO do
      description "TODO"
    end
