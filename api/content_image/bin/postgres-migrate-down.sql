...
DROP INDEX IF EXISTS index_content_image_updated_by;
DROP INDEX IF EXISTS index_content_image_retired_at;
DROP INDEX IF EXISTS index_content_image_retired_by;
