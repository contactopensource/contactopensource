...
mix phx.gen.html \
    Plan PlanINVEST None \
        ...
        independent_as_markdown:stringNone \
        negotiable_as_markdown:stringNone \
        valuable_as_markdown:stringNone \
        estimable_as_markdown:stringNone \
        small_as_markdown:stringNone \
        testable_as_markdown:stringNone \
    --force \
    --no-timestamps \
