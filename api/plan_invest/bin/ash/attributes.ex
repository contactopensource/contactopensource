...
defmodule MyApp.MyDomain.PlanINVEST.Attributes do
  ...
  attributes do
    ...
    attribute :plan_id, :plan.id do
    end

    attribute :independent_as_markdown, :string do
      description "Independent: must be self-contained."
    end

    attribute :negotiable_as_markdown, :string do
      description "Negotiable: must enable space for discussion, and is not an explicit contract."
    end

    attribute :valuable_as_markdown, :string do
      description "Valuable: must deliver value to the stakeholders, such as the customers and users."
    end

    attribute :estimable_as_markdown, :string do
      description "Estimable: must always be able to estimate, such as for time, cost, and materials."
    end

    attribute :small_as_markdown, :string do
      description "Small: must be possible to plan/task/order within a level of accuracy."
    end

    attribute :testable_as_markdown, :string do
      description "Testable: must provide the necessary information to make test development possible."
    end
