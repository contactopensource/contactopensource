...
Plan INVEST criteria, such as for agile items: Independent, Negotiable, Valuable, Estimable, Small, and Testable.
...
Main:
  ...
  * independent_as_markdown: string

  * negotiable_as_markdown: string

  * valuable_as_markdown: string

  * estimable_as_markdown: string

  * small_as_markdown: string

  * testable_as_markdown: string
