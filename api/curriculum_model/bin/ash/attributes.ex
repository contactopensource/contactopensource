...
defmodule MyApp.MyDomain.CurriculumModel.Attributes do
  ...
  attributes do
    ...
    attribute :strengths_description_as_markdown, :markdown do
      description "strengths description as markdown."
    end

    attribute :limitations_description_as_markdown, :markdown do
      description "limitations description as markdown."
    end
