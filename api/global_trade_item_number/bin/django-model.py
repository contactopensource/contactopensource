...
class GlocalTradeItemNumber(models.Model):
        ...
        prefix = models.UnknownAttribute("GS1 prefix, typically a company-specific prefix")
        item = models.UnknownAttribute("None")
        check_digit = models.UnknownAttribute("None")
        indicator_digit = models.UnknownAttribute("None")
