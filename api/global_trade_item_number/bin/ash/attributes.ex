...
defmodule MyApp.MyDomain.GlobalTradeItemNumber.Attributes do
  ...
  attributes do
    ...
    attribute :code, :digit do
    end

    attribute :prefix, :digit do
      description "GS1 prefix, typically a company-specific prefix"
    end

    attribute :item, :digit do
    end

    attribute :check_digit, :digit do
    end

    attribute :indicator_digit, :digit do
    end
