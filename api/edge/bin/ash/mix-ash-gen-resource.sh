...
touch test/my_app/my_domain/edge.exs
...
touch test/my_app_web/live/edges/form_test.exs
touch test/my_app_web/live/edges/index_test.exs
touch test/my_app_web/live/edges/show_test.exs
...
If there is a parent, then edit file lib/my_app/edge.ex to add:
