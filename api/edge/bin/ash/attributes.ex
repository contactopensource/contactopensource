...
defmodule MyApp.MyDomain.Edge.Attributes do
  ...
  attributes do
    ...
    attribute :subject_uri, :text do
      description "type identifier, such as an RDF link, or semantic URL, or internal URN"
    end

    attribute :subject_database, :text do
      description "database identifier, such as a database instance name"
    end

    attribute :subject_schema, :text do
      description "schema identifier, such as a database instance schema name"
    end

    attribute :subject_table, :text do
      description "table identifier, such as a database instance schema table name"
    end

    attribute :subject_id, :id do
      description "row identifier, such as a database instance schema table row primary key"
    end

    attribute :predicate_uri, :text do
      description "type identifier, such as an RDF link, or semantic URL, or internal URN"
    end

    attribute :predicate_database, :text do
      description "database identifier, such as a database instance name"
    end

    attribute :predicate_schema, :text do
      description "schema identifier, such as a database instance schema name"
    end

    attribute :predicate_table, :text do
      description "table identifier, such as a database instance schema table name"
    end

    attribute :predicate_id, :id do
      description "row indentifier, such as a database instance schema table row primary key"
    end

    attribute :object_uri, :text do
      description "type identifier, such as an RDF link, or semantic URL, or internal URN"
    end

    attribute :object_database, :text do
      description "database identifier, such as a database instance name"
    end

    attribute :object_schema, :text do
      description "object schema"
    end

    attribute :object_table, :text do
      description "table identifier, such as a database instance schema table name"
    end

    attribute :object_id, :id do
      description "row indentifier, such as a database instance schema table row primary key"
    end

    attribute :start_at_timestamp_utc, :timestamp_utc_usec do
      description "start at timestamp utc"
    end

    attribute :stop_at_timestamp_utc, :timestamp_utc_usec do
      description "stop at timestamp utc"
    end

    attribute :count, :integer do
      description "any kind of count, and the usage is up to the application"
    end

    attribute :unit_interval, :unit_interval do
      description "any kind of unit interval, and the usage is up to the application"
    end

    attribute :dual_interval, :dual_interval do
      description "any kind of dual intervale and the usage is up to the application"
    end
