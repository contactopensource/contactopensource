...
touch test/my_app/my_domain/system_proc.exs
...
touch test/my_app_web/live/system_procs/form_test.exs
touch test/my_app_web/live/system_procs/index_test.exs
touch test/my_app_web/live/system_procs/show_test.exs
...
If there is a parent, then edit file lib/my_app/system_proc.ex to add:
