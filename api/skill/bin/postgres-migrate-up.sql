...
CREATE INDEX index_skill_retired_at on skill(retired_at);
CREATE INDEX index_skill_retired_by on skill(retired_by);
CREATE INDEX index_skill_locale_code on skill(locale_code);
CREATE INDEX index_skill_tagging on skill(tagging);
