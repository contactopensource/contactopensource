...
touch test/my_app/my_domain/skill.exs
...
touch test/my_app_web/live/skills/form_test.exs
touch test/my_app_web/live/skills/index_test.exs
touch test/my_app_web/live/skills/show_test.exs
...
If there is a parent, then edit file lib/my_app/skill.ex to add:
