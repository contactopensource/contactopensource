...
CREATE INDEX index_currency_type_zid on currency_type(zid);
CREATE INDEX index_currency_type_title on currency_type(title);
CREATE INDEX index_currency_type_subtitle on currency_type(subtitle);
