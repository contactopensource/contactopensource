...
DROP INDEX IF EXISTS index_measurement_unit_sign;
DROP INDEX IF EXISTS index_measurement_unit_created_at;
...
DROP INDEX IF EXISTS index_measurement_unit_locale_id;
