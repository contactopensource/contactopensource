...
touch test/my_app/my_domain/content_message.exs
...
touch test/my_app_web/live/content_messages/form_test.exs
touch test/my_app_web/live/content_messages/index_test.exs
touch test/my_app_web/live/content_messages/show_test.exs
...
If there is a parent, then edit file lib/my_app/content_message.ex to add:
