...
CREATE INDEX index_code_metrics_kit_deleted_at on code_metrics_kit(deleted_at);
CREATE INDEX index_code_metrics_kit_deleted_by on code_metrics_kit(deleted_by);
