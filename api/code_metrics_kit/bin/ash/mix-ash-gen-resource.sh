...
touch test/my_app/my_domain/code_metrics_kit.exs
...
touch test/my_app_web/live/code_metrics_kits/form_test.exs
touch test/my_app_web/live/code_metrics_kits/index_test.exs
touch test/my_app_web/live/code_metrics_kits/show_test.exs
...
If there is a parent, then edit file lib/my_app/code_metrics_kit.ex to add:
