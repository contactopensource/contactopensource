...
defmodule MyApp.MyDomain.PADDIEMInstructionalDesignModel.Attributes do
  ...
  attributes do
    ...
    attribute :phase_1_planning_as_markdown, :markdown do
      description "Define the scope, resources, and timeline for the training project."
    end

    attribute :phase_2_analysis_as_markdown, :markdown do
      description "Identify training needs, conducting job task analysis (JDTA), and determining performance gaps."
    end

    attribute :phase_3_design_as_markdown, :markdown do
      description "Develop learning objectives, assessment tools, and the training structure."
    end

    attribute :phase_4_development_as_markdown, :markdown do
      description "Create the actual training materials, including courseware and instructor guides."
    end

    attribute :phase_5_implementation_as_markdown, :markdown do
      description "Deliver the training to sailors, often via Navy eLearning (NeL) or in-person instruction."
    end

    attribute :phase_6_evaluation_as_markdown, :markdown do
      description "Assess the effectiveness of the training (internal and external) to ensure it meets operational requirements."
    end

    attribute :phase_7_maintenance_as_markdown, :markdown do
      description "Review and update the training content to ensure it remains accurate and relevant to current fleet operations."
    end
