...
mix ash.gen.resource \
    ...
    --attribute phase_1_planning_as_markdown:markdown \
    --attribute phase_2_analysis_as_markdown:markdown \
    --attribute phase_3_design_as_markdown:markdown \
    --attribute phase_4_development_as_markdown:markdown \
    --attribute phase_5_implementation_as_markdown:markdown \
    --attribute phase_6_evaluation_as_markdown:markdown \
    --attribute phase_7_maintenance_as_markdown:markdown \
