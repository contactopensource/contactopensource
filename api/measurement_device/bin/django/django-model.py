...
class MeasurementDevice(models.Model):
        ...
        stock_keeping_unit_id = models.ForeignKey("Stock keeping unit, such as for a brand, kit, model, etc.", StockKeepingUnitId, on_delete=models.CASCADE)("Stock keeping unit, such as for a brand, kit, model, etc.")
