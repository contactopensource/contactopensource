...
defmodule MyApp.MyDomain.MeasurementDevice.Attributes do
  ...
  attributes do
    ...
    attribute :name, :text do
      description "Name suitable for display"
    end

    attribute :name_phonetic, :text do
      description "Name phonetic"
    end

    attribute :stock_keeping_unit_id, :stock_keeping_unit.id do
      description "Stock keeping unit, such as for a brand, kit, model, etc."
    end
