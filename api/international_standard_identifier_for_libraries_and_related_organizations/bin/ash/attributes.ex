...
defmodule MyApp.MyDomain.InternationalStandardIdentifierForLibrariesAndRelatedOrganizations.Attributes do
  ...
  attributes do
    ...
    attribute :key, :varchar do
    end

    attribute :prefix, :varchar do
    end

    attribute :suffix, :varchar do
    end
