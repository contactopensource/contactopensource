...
class InternationalStandardIdentifierForLibrariesAndRelatedOrganizations(models.Model):
        ...
        key = models.UnknownAttribute("None")
        prefix = models.UnknownAttribute("None")
        suffix = models.UnknownAttribute("None")
