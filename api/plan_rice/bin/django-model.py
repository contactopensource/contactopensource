...
class PlanRICE(models.Model):
        ...
        reach_card_id = models.ForeignKey("Reach: The number of people or customers who will be affected by the idea.", ReachCardId, on_delete=models.CASCADE)("Reach: The number of people or customers who will be affected by the idea.")
        reach_value = models.UnknownAttribute("Reach value")
        impact_card_id = models.ForeignKey("Impact: The potential value or impact of the idea.", ImpactCardId, on_delete=models.CASCADE)("Impact: The potential value or impact of the idea.")
        impact_value = models.UnknownAttribute("Impact value")
        confidence_card_id = models.ForeignKey("Confidence: The level of certainty in the estimates", ConfidenceCardId, on_delete=models.CASCADE)("Confidence: The level of certainty in the estimates")
        confidence_value = models.UnknownAttribute("Confidence value")
        effort_card_id = models.ForeignKey("Effort: The resources required to complete the project, such as time and money.", EffortCardId, on_delete=models.CASCADE)("Effort: The resources required to complete the project, such as time and money.")
