...
defmodule MyApp.MyDomain.PlanRICE.Attributes do
  ...
  attributes do
    ...
    attribute :score, :number do
      description "RICE score = Reach * Impact * Confidence / Effort"
    end

    attribute :reach_card_id, :card.id do
      description "Reach: The number of people or customers who will be affected by the idea."
    end

    attribute :reach_value, :number do
      description "Reach value"
    end

    attribute :impact_card_id, :card.id do
      description "Impact: The potential value or impact of the idea."
    end

    attribute :impact_value, :number do
      description "Impact value"
    end

    attribute :confidence_card_id, :card.id do
      description "Confidence: The level of certainty in the estimates"
    end

    attribute :confidence_value, :number do
      description "Confidence value"
    end

    attribute :effort_card_id, :card.id do
      description "Effort: The resources required to complete the project, such as time and money."
    end

    attribute :effort_value, :number do
