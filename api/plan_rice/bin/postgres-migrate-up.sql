...
CREATE INDEX index_plan_rice_deleted_at on plan_rice(deleted_at);
CREATE INDEX index_plan_rice_deleted_by on plan_rice(deleted_by);
CREATE INDEX index_plan_rice_locale_id on plan_rice(locale_id);
CREATE INDEX index_plan_rice_title on plan_rice(title);
CREATE INDEX index_plan_rice_subtitle on plan_rice(subtitle);
