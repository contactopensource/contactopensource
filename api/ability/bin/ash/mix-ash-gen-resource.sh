...
touch test/my_app/my_domain/ability.exs
...
touch test/my_app_web/live/abilities/form_test.exs
touch test/my_app_web/live/abilities/index_test.exs
touch test/my_app_web/live/abilities/show_test.exs
...
If there is a parent, then edit file lib/my_app/ability.ex to add:
