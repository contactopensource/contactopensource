...
touch test/my_app/my_domain/person.exs
...
touch test/my_app_web/live/persons/form_test.exs
touch test/my_app_web/live/persons/index_test.exs
touch test/my_app_web/live/persons/show_test.exs
...
If there is a parent, then edit file lib/my_app/person.ex to add:
