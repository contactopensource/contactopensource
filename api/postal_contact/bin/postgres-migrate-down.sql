...
DROP INDEX IF EXISTS index_postal_contact_retired_at;
DROP INDEX IF EXISTS index_postal_contact_retired_by;
DROP INDEX IF EXISTS index_postal_contact_locale_code;
DROP INDEX IF EXISTS index_postal_contact_tagging;
