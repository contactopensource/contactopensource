...
DROP INDEX IF EXISTS index_postal_contact_updated_by;
DROP INDEX IF EXISTS index_postal_contact_deleted_at;
DROP INDEX IF EXISTS index_postal_contact_deleted_by;
DROP INDEX IF EXISTS index_postal_contact_locale_id;
