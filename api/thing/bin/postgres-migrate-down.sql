...
DROP INDEX IF EXISTS index_thing_updated_by;
DROP INDEX IF EXISTS index_thing_retired_at;
DROP INDEX IF EXISTS index_thing_retired_by;
DROP INDEX IF EXISTS index_thing_locale_code;
DROP INDEX IF EXISTS index_thing_tagging;
