...
touch test/my_app/my_domain/thing.exs
...
touch test/my_app_web/live/things/form_test.exs
touch test/my_app_web/live/things/index_test.exs
touch test/my_app_web/live/things/show_test.exs
...
If there is a parent, then edit file lib/my_app/thing.ex to add:
