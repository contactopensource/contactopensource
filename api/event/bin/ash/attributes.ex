...
defmodule MyApp.MyDomain.Event.Attributes do
  ...
  attributes do
    ...
    attribute :start_timestamp_local, :timestamp_utc_usec do
    end

    attribute :stop_timestamp_local, :timestamp_utc_usec do
    end

    attribute :start_timestamp_utc, :timestamp_utc_usec do
    end

    attribute :stop_timestamp_utc, :timestamp_utc_usec do
    end
    ...
    attribute :recurring_description, :text do
    end
