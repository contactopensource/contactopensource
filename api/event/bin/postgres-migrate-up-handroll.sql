CREATE TABLE event (
  ...
  locale_code text,
  parent_id uuid CONSTRAINT event_parent_id_fk REFERENCES event (id),
  parent_order int CONSTRAINT event_parent_order_check CHECK (parent_order >= 0),
  --- card
  name text,
  sign text CONSTRAINT event_sign_check CHECK (LENGTH(sign) = 1),
  status text,
  tagging text,
  note text,
  --- contact
  web text CONSTRAINT event_web_check CHECK (web ~* '^https://'),
  email text CONSTRAINT event_email_check CHECK (email ~*  '.@.'),
  phone text,
  chat text,
  calendar text,
  postal text,
  rdf_type text,
  --- social
  bluesky_as_url text CONSTRAINT event_bluesky_as_url_check CHECK (bluesky_as_url ~* '^https://bsky\.app/'),
  codeberg_as_url text CONSTRAINT event_codeberg_as_url_check CHECK (codeberg_as_url ~* '^https://codeberg\.org/'),
  facebook_as_url text CONSTRAINT event_facebook_as_url_check CHECK (facebook_as_url ~* '^https://facebook\.com/'),
  github_as_url text CONSTRAINT event_github_as_url_check CHECK (github_as_url ~* '^https://github\.com/'),
  instagram_as_url text CONSTRAINT event_instagram_as_url_check CHECK (instagram_as_url ~* '^https://instagram\.com/'),
  linkedin_as_url text CONSTRAINT event_linkedin_as_url_check CHECK (linkedin_as_url ~* '^https://linkedin\.com/'),
  mastodon_as_url text CONSTRAINT event_mastodon_as_url_check CHECK (mastodon_as_url ~* '^https://'),
  orcid_as_url text CONSTRAINT event_orcid_as_url_check CHECK (orcid_as_url ~* '^https://orcid\.org/'),
  tiktok_as_url text CONSTRAINT event_tiktok_as_url_check CHECK (tiktok_as_url ~* '^https://tiktok\.com/'),
  wikipedia_as_url text CONSTRAINT event_wikipedia_uri_check CHECK (wikipedia_as_url ~* '^https://wikipedia\.org/'),
  youtube_as_url text CONSTRAINT event_youtube_as_url_check CHECK (youtube_as_url ~* '^https://youtube\.com/'),
  --- location
  location_iso_3166_1_alpha_2 char(2) CONSTRAINT event_location_iso_3166_1_alpha_2_check CHECK (location_iso_3166_1_alpha_2 ~* '^[a-z][a-z]$'),
  location_iso_3166_2 text,
  location_postal_code text,
  location_latitude_as_decimal_degrees numeric(9, 7) CONSTRAINT event_location_latitude_as_decimal_degrees_check CHECK (location_latitude_as_decimal_degrees BETWEEN -90.0 AND 90.0),
  location_longitude_as_decimal_degrees numeric(10, 7) CONSTRAINT event_location_longitude_as_decimal_degrees_check CHECK (location_longitude_as_decimal_degrees BETWEEN -180.0 AND 180.0),
  --- images
  avatar_image_400x400_url text CONSTRAINT event_avatar_image_400x400_url_check CHECK (avatar_image_400x400_url ~* '^https://'),
  avatar_image_400x400_alt text,
  main_image_1080x1080_url text CONSTRAINT event_main_image_1080x1080_url_check CHECK (main_image_1080x1080_url ~* '^https://'),
  main_image_1080x1080_alt text,
  main_image_1920x1080_url text CONSTRAINT event_main_image_1920x1080_url_check CHECK (main_image_1920x1080_url ~* '^https://'),
  main_image_1920x1080_alt text,
  main_image_1080x1920_url text CONSTRAINT event_main_image_1080x1920_url_check CHECK (main_image_1080x1920_url ~* '^https://'),
  ...
  -- ai
  ai_agent_instructions_as_url text CONSTRAINT event_ai_agent_instructions_as_url CHECK (ai_agent_instructions_as_url ~* '^https://'),
  ai_agent_instructions_as_markdown text,
  --- emoji
  home_emoji_url text CONSTRAINT event_home_emoji_url_check CHECK (home_emoji_url ~* '^https://'),
  bellhop_bell_emoji_url text CONSTRAINT event_bellhop_bell_emoji_url_check CHECK (bellhop_bell_emoji_url ~* '^https://'),
  target_emoji_url text CONSTRAINT event_target_emoji_url_check CHECK (target_emoji_url ~* '^https://'),
  gear_emoji_url text CONSTRAINT event_gear_emoji_url_check CHECK (gear_emoji_url ~* '^https://'),
  spiral_calendar_emoji_url text CONSTRAINT event_spiral_calendar_emoji_url_check CHECK (spiral_calendar_emoji_url ~* '^https://'),
  sparkles_emoji_url text CONSTRAINT event_sparkles_emoji_url_check CHECK (sparkles_emoji_url ~* '^https://'),
  speech_bubble_emoji_url text CONSTRAINT event_speech_bubble_emoji_url_check CHECK (speech_bubble_emoji_url ~* '^https://'),
  newspaper_emoji_url text CONSTRAINT event_newspaper_emoji_url_check CHECK (newspaper_emoji_url ~* '^https://'),
  bar_chart_emoji_url text CONSTRAINT event_bar_chart_emoji_url_check CHECK (bar_chart_emoji_url ~* '^https://'),
  movie_camera_emoji_url text CONSTRAINT event_movie_camera_emoji_url_check CHECK (movie_camera_emoji_url ~* '^https://'),
  construction_worker_emoji_url text CONSTRAINT event_construction_worker_emoji_url_check CHECK (construction_worker_emoji_url ~* '^https://'),
  crystal_ball_emoji_url text CONSTRAINT event_crystal_ball_emoji_url_check CHECK (crystal_ball_emoji_url ~* '^https://'),
  butterfly_emoji_url text CONSTRAINT event_butterfly_emoji_url_check CHECK (butterfly_emoji_url ~* '^https://'),
  lady_beetle_emoji_url text CONSTRAINT event_lady_beetle_emoji_url_check CHECK (lady_beetle_emoji_url ~* '^https://'),
  --
  objectives_and_key_results_as_markdown text,
  key_performance_indicators_as_markdown text,
  glossary_as_url text CONSTRAINT event_glossary_as_url_check CHECK (glossary_as_url ~* '^https://'),
  ...
  six_pager_double_sider_as_url text CONSTRAINT event_six_pager_double_sider_as_url_check CHECK (six_pager_double_sider_as_url ~* '^https://'),
  six_pager_double_sider_as_markdown text,
  roles_and_responsibilities_as_url text CONSTRAINT event_roles_and_responsibilities_as_url_check CHECK (roles_and_responsibilities_as_url ~* '^https://'),
  roles_and_responsibilities_as_markdown text,
  responsibility_assignment_matrix_as_url text CONSTRAINT event_responsibility_assignment_matrix_as_url_check CHECK (responsibility_assignment_matrix_as_url ~* '^https://'),
  ...
  isic_v4_name text,
  -- swot
  swot_as_url text CONSTRAINT event_swot_as_url_check CHECK (swot_as_url ~* '^https://'),
  ...
  --- sipoc
  sipoc_as_url text CONSTRAINT event_sipoc_as_url_check CHECK (sipoc_as_url ~* '^https://'),
  ...
  --- steeple
  steeple_as_url text CONSTRAINT event_steeple_as_url_check CHECK (steeple_as_url ~* '^https://'),
  ...
  --- porters five forces
  porters_five_forces_as_url text CONSTRAINT event_porters_five_forces_as_url_check CHECK (porters_five_forces_as_url ~* '^https://'),
  ...
  --- Policies
  code_of_conduct_policy_as_url text CONSTRAINT event_code_of_conduct_policy_as_url_check CHECK (code_of_conduct_policy_as_url ~* '^https://'),
  code_of_conduct_policy_as_markdown text,
  coordinated_disclosure_policy_as_url text CONSTRAINT event_coordinated_disclosure_policy_as_url_check CHECK (coordinated_disclosure_policy_as_url ~* '^https://'),
  coordinated_disclosure_policy_as_markdown text,
  copyright_policy_as_url text CONSTRAINT event_copyright_policy_as_url_check CHECK (copyright_policy_as_url ~* '^https://'),
  copyright_policy_as_markdown text,
  corrections_policy_as_url text CONSTRAINT event_corrections_policy_as_url_check CHECK (corrections_policy_as_url ~* '^https://'),
  corrections_policy_as_markdown text,
  diversity_policy_as_url text CONSTRAINT event_diversity_policy_as_url_check CHECK (diversity_policy_as_url ~* '^https://'),
  diversity_policy_as_markdown text,
  equal_opportunity_policy_as_url text CONSTRAINT event_equal_opportunity_policy_as_url_check CHECK (equal_opportunity_policy_as_url ~* '^https://'),
  equal_opportunity_policy_as_markdown text,
  ethics_policy_as_url text CONSTRAINT event_ethics_policy_as_url_check CHECK (ethics_policy_as_url ~* '^https://'),
  ethics_policy_as_markdown text,
  legal_policy_as_url text CONSTRAINT event_legal_policy_as_url_check CHECK (legal_policy_as_url ~* '^https://'),
  legal_policy_as_markdown text,
  license_policy_as_url text CONSTRAINT event_license_policy_as_url_check CHECK (license_policy_as_url ~* '^https://'),
  license_policy_as_markdown text,
  open_source_policy_as_url text CONSTRAINT event_open_source_policy_as_url_check CHECK (open_source_policy_as_url ~* '^https://'),
  open_source_policy_as_markdown text,
  privacy_policy_as_url text CONSTRAINT event_privacy_policy_as_url_check CHECK (privacy_policy_as_url ~* '^https://'),
  privacy_policy_as_markdown text,
  safety_policy_as_url text CONSTRAINT event_safety_policy_as_url_check CHECK (safety_policy_as_url ~* '^https://'),
  safety_policy_as_markdown text,
  security_policy_as_url text CONSTRAINT event_security_policy_as_url_check CHECK (security_policy_as_url ~* '^https://'),
  security_policy_as_markdown text,
  socials_policy_as_url text CONSTRAINT event_socials_policy_as_url_check CHECK (socials_policy_as_url ~* '^https://'),
  socials_policy_as_markdown text,
  staff_policy_as_url text CONSTRAINT event_staff_policy_as_url_check CHECK (staff_policy_as_url ~* '^https://'),
  staff_policy_as_markdown text,
  --- arc42
  arc42_as_url text CONSTRAINT event_arc42_as_url_check CHECK (arc42_as_url ~* '^https://'),
  ...
  -- apache_echart
  apache_echart_as_url text CONSTRAINT event_apache_echart_as_url_check CHECK (apache_echart_as_url ~* '^https://'),
...
CREATE INDEX event_name_index_tpo ON event (name text_pattern_ops);
CREATE INDEX event_tagging_index ON event (tagging);
CREATE INDEX event_tagging_index_tpo ON event (tagging text_pattern_ops);
CREATE INDEX event_location_iso_3166_1_alpha_2_index on event (location_iso_3166_1_alpha_2 );
CREATE INDEX event_location_iso_3166_2_index on event (location_iso_3166_2);
CREATE INDEX event_location_postal_code_index on event (location_postal_code);
CREATE INDEX event_location_latitude_as_decimal_degrees_index on event (location_latitude_as_decimal_degrees);
CREATE INDEX event_location_longitude_as_decimal_degrees_index on event (location_longitude_as_decimal_degrees);
CREATE INDEX event_gs1_digital_link_index ON event (gs1_digital_link);
CREATE INDEX event_gs1_country_code_index ON event (gs1_country_code);
CREATE INDEX event_gs1_global_location_number_index ON event (gs1_global_location_number);
CREATE INDEX event_isic_v4_code_index ON event (isic_v4_code);
