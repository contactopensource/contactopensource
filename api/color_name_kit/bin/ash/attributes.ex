...
defmodule MyApp.MyDomain.ColorNameKit.Attributes do
  ...
  attributes do
    ...
    attribute :hex, :hexdigit do
      description "hexadecimal-lowercase six-character code"
    end

    attribute :html_color_name, :text do
      description "See https://wikipedia.org/wiki/Web_colors#HTML_color_names"
    end

    attribute :x11_color_name, :text do
      description "See https://en.wikipedia.org/wiki/X11_color_names"
    end

    attribute :color_naming_system_name, :text do
      description "See https://en.wikipedia.org/wiki/Color_Naming_System"
    end

    attribute :pantone_process_color_name, :text do
      description "See https://en.wikipedia.org/wiki/Pantone"
    end
