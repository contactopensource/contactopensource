...
touch test/my_app/my_domain/color_name_kit.exs
...
touch test/my_app_web/live/color_name_kits/form_test.exs
touch test/my_app_web/live/color_name_kits/index_test.exs
touch test/my_app_web/live/color_name_kits/show_test.exs
...
If there is a parent, then edit file lib/my_app/color_name_kit.ex to add:
