...
touch test/my_app/my_domain/system_path.exs
...
touch test/my_app_web/live/system_paths/form_test.exs
touch test/my_app_web/live/system_paths/index_test.exs
touch test/my_app_web/live/system_paths/show_test.exs
...
If there is a parent, then edit file lib/my_app/system_path.ex to add:
