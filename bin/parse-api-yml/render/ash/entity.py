...
def render(args, entity):
    ...
    s += f"touch test/{args.app_name_snake_case}_web/live/{entity.snake_case_plural}/form_test.ex\n"
    s += f"touch test/{args.app_name_snake_case}_web/live/{entity.snake_case_plural}/index_test.ex\n"
    s += f"touch test/{args.app_name_snake_case}_web/live/{entity.snake_case_plural}/show_test.ex\n"
    s += "\n"
    s += "cat << EOF\n"
