...
def render(args, entity):
    ...
    s += f"    {args.app_name_title_case}.{entity.module}.{entity.title_case_singular} \\\n"
    s += "    --conflicts replace \\\n"
    ...
    s += f"touch test/{args.app_name_snake_case}/{args.ddd_name_snake_case}/{entity.snake_case_singular}.exs\n"
    s += "\n"
    ...
    s += f"touch test/{args.app_name_snake_case}_web/live/{entity.snake_case_plural}/form_test.exs\n"
    s += f"touch test/{args.app_name_snake_case}_web/live/{entity.snake_case_plural}/index_test.exs\n"
    s += f"touch test/{args.app_name_snake_case}_web/live/{entity.snake_case_plural}/show_test.exs\n"
    s += "\n"
    s += "cat << EOF\n"
    ...
    s += f"\n"
    s += f"If there is a parent, then edit file lib/{args.app_name_snake_case}/{entity.id}.ex to add:\n"
    s += f"\n"
    s += f"\nrelationships do\n"
